...
public class GameClient extends JFrame implements ActionListener {
	...
	void miTurno () { 
        ...
        void muestraJugada (byte player1Pick, byte player2Pick, byte player3Pick) {
            ...
            setMessage ("Jugador 1: " + movimientos[player1Pick] + 
                        " Jugador 2: " + movimientos[player2Pick] + 
                        " Jugador 3: " + movimientos[player3Pick]);
        }
	...
	private void initRMI () {
		...
		player.block();
			...
			nPlayer = game.conectar((CallBackInterface) callback, jugador, pass);
			if (nPlayer.equals("")) System.exit(0);
	...
	public void actionPerformed (ActionEvent event) {
            ...
            byte movimiento = 0;
            if (eleccion.getActionCommand().equals(movimientos[0])) movimiento = 0;
            else if (eleccion.getActionCommand().equals(movimientos[1])) movimiento = 1;
            else if (eleccion.getActionCommand().equals(movimientos[2])) movimiento = 2;
            else if (eleccion.getActionCommand().equals(movimientos[3])) movimiento = 3;
            else if (eleccion.getActionCommand().equals(movimientos[4])) movimiento = 4;
